  ...
  'zh-CN': {
    ...
    crm: {
      ...
      status: {
        ...
        modelConfirming: '待完成选配',
        optionsIncomplete: '待完成选配',
        completed: '选配完成',
        processing: '待完成选配',
      },
      placeholder: {
      ...
      statusDesc: {
        pendingConfig: '请完成机型与选项选择后再确认价格。',
        etoPending: '含非标准项，需要ETO工程评审。',
        directOrder: '配置完整且价格明确，可直接下单。',
      },
      toast: {
  ...
  'en-US': {
    ...
    crm: {
      ...
      status: {
        ...
        modelConfirming: 'Configuration Pending',
        optionsIncomplete: 'Configuration Pending',
        completed: 'Completed',
        processing: 'Configuration Pending',
      },
      statusDesc: {
        pendingConfig: 'Complete model/options selection before pricing confirmation.',
        etoPending: 'Contains non-standard items and requires ETO engineering review.',
        directOrder: 'Configuration is complete with confirmed pricing and ready to order.',
      },
      placeholder: {
